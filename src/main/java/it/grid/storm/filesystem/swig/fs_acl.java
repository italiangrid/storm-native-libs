...
public class fs_acl {
  ...
  public void load(String pathname, boolean delete_also) throws it.grid.storm.filesystem.FilesystemError, java.lang.RuntimeException {
    posixapi_interfaceJNI.fs_acl_load__SWIG_0(swigCPtr, this, pathname, delete_also);
  }
  ...
  public boolean is_group_perm_masked(int gid) {
    return posixapi_interfaceJNI.fs_acl_is_group_perm_masked(swigCPtr, this, gid);
  }
  ...
  public boolean is_user_perm_masked(int uid) {
    return posixapi_interfaceJNI.fs_acl_is_user_perm_masked(swigCPtr, this, uid);
  }

  public int get_group_effective_perm(int gid) {
    return posixapi_interfaceJNI.fs_acl_get_group_effective_perm(swigCPtr, this, gid);
  }
  ...
  public int get_user_effective_perm(int uid) {
    return posixapi_interfaceJNI.fs_acl_get_user_effective_perm(swigCPtr, this, uid);
  }
  ...
  public int grant_group_owner_perm(int perm) {
    return posixapi_interfaceJNI.fs_acl_grant_group_owner_perm(swigCPtr, this, perm);
  }

  public int grant_group_perm(int gid, int perm) {
    return posixapi_interfaceJNI.fs_acl_grant_group_perm(swigCPtr, this, gid, perm);
  }

  public int grant_group_perm_not_owner(int gid, int perm) {
    return posixapi_interfaceJNI.fs_acl_grant_group_perm_not_owner(swigCPtr, this, gid, perm);
  }
  ...
  public int grant_user_perm(int uid, int perm) {
    return posixapi_interfaceJNI.fs_acl_grant_user_perm(swigCPtr, this, uid, perm);
  }

  public int grant_user_perm_not_owner(int uid, int perm) {
    return posixapi_interfaceJNI.fs_acl_grant_user_perm_not_owner(swigCPtr, this, uid, perm);
  }
  ...
  public int remove_group_perm_not_owner(int gid) {
    return posixapi_interfaceJNI.fs_acl_remove_group_perm_not_owner(swigCPtr, this, gid);
  }

  public int remove_user_perm_not_owner(int uid) {
    return posixapi_interfaceJNI.fs_acl_remove_user_perm_not_owner(swigCPtr, this, uid);
  }

  public int revoke_group_owner_perm(int perm) {
    return posixapi_interfaceJNI.fs_acl_revoke_group_owner_perm(swigCPtr, this, perm);
  }

  public int revoke_group_perm(int gid, int perm) {
    return posixapi_interfaceJNI.fs_acl_revoke_group_perm(swigCPtr, this, gid, perm);
  }

  public int revoke_group_perm_not_owner(int gid, int perm) {
    return posixapi_interfaceJNI.fs_acl_revoke_group_perm_not_owner(swigCPtr, this, gid, perm);
  }
  ...
  public int revoke_user_perm(int uid, int perm) {
    return posixapi_interfaceJNI.fs_acl_revoke_user_perm(swigCPtr, this, uid, perm);
  }

  public int revoke_user_perm_not_owner(int uid, int perm) {
    return posixapi_interfaceJNI.fs_acl_revoke_user_perm_not_owner(swigCPtr, this, uid, perm);
  }

  public int set_group_owner_perm(int perm) {
    return posixapi_interfaceJNI.fs_acl_set_group_owner_perm(swigCPtr, this, perm);
  }

  public int set_group_perm(int gid, int perm) {
    return posixapi_interfaceJNI.fs_acl_set_group_perm(swigCPtr, this, gid, perm);
  }

  public int set_group_perm_not_owner(int gid, int perm) {
    return posixapi_interfaceJNI.fs_acl_set_group_perm_not_owner(swigCPtr, this, gid, perm);
  }
  ...
  public int set_other_perm(int new_other_perm) {
    return posixapi_interfaceJNI.fs_acl_set_other_perm(swigCPtr, this, new_other_perm);
  }
  ...
  public int set_user_perm(int uid, int perm) {
    return posixapi_interfaceJNI.fs_acl_set_user_perm(swigCPtr, this, uid, perm);
  }

  public int set_user_perm_not_owner(int uid, int perm) {
    return posixapi_interfaceJNI.fs_acl_set_user_perm_not_owner(swigCPtr, this, uid, perm);
  }
  ...
  public int[] get_uid_list() { return posixapi_interfaceJNI.fs_acl_get_uid_list(swigCPtr, this); }

  public long get_uid_list_size() {
    return posixapi_interfaceJNI.fs_acl_get_uid_list_size(swigCPtr, this);
  }

  public int[] get_gid_list() { return posixapi_interfaceJNI.fs_acl_get_gid_list(swigCPtr, this); }
