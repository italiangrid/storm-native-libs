...
public class gpfs extends genericfs {
  ...
  public long get_exact_last_modification_time(String pathname)
    ...
    return gpfsapi_interfaceJNI.gpfs_get_exact_last_modification_time(swigCPtr,
      this, pathname);
  }
  ...
  public int truncate_file(String filename, long desired_size)
    ...
    return gpfsapi_interfaceJNI.gpfs_truncate_file(swigCPtr, this, filename,
      desired_size);
  }
  ...
  public long get_number_of_blocks(String filename)
    ...
    return gpfsapi_interfaceJNI.gpfs_get_number_of_blocks(swigCPtr, this,
      filename);
  }
  ...
  public boolean is_quota_enabled(String fileset_root)
    ...
    return gpfsapi_interfaceJNI.gpfs_is_quota_enabled(swigCPtr, this,
      fileset_root);
  }
  ...
  public quota_info get_fileset_quota_info(String fileset_root)
    ...
    return new quota_info(gpfsapi_interfaceJNI.gpfs_get_fileset_quota_info(
      swigCPtr, this, fileset_root), true);
  }
